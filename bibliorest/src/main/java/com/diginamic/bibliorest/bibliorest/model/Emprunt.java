package com.diginamic.bibliorest.bibliorest.model;
...
public class Emprunt
{
	...
	private int delai;
	/**
	 * clientE est un nom unique dans toutes mes entities car je vais utiliser
	 * "mappedBy"
	 * 
	...
	/**
	 * par mappedBy="empruntLivres" je récupère automatiquement les livres empruntés
	 */
