...
public class TestBibliotheque 
{
	...
	public static void main( String[] args )
    {
	     ...
	     */  
	        ...
	        em.getTransaction().begin();
	        EClient ecli = new EClient();
	        ecli.setNom("TZU");
	        ecli.setPrenom("SUN");
	        em.persist(ecli);
	        em.getTransaction().commit();
	        System.out.println(ecli.getNom() + ecli.getPrenom());
	      ...
	      */
	        ...
	        /****     TP03     *****/
	        	...
	        	/*****     R�alisez une requ�te qui permet d�extraire un emprunt et tous ses livres associ�s.     *****/
	        /*
    		...
    		*/
	        	...
	        	/*****     R�alisez une requ�te qui permet d�extraire tous les emprunts d�un client donn�.     *****/
    		/*
